...
import svc.modules.attentions as attentions
import svc.modules.commons as commons
import svc.modules.modules as modules
import utils
from svc.modules.commons import get_padding
...
class SynthesizerTrn(nn.Module):
    ...
    def __init__(self,
        ...
        if vocoder_name == "nsf-hifigan":
            from svc.vdecoder.hifigan.models import Generator
            self.dec = Generator(h=hps)
        elif vocoder_name == "nsf-snake-hifigan":
            from svc.vdecoder.hifiganwithsnake.models import Generator
            self.dec = Generator(h=hps)
        else:
